 ...
 * </code>
 * @reference: http://aesencryption.net/
 */

namespace common\utilities\AES;
...
class AES {
    ...
    public function encrypt() {
        ...
        if ($this->validateParams()) {
            ...
            throw new Exception('Invalid params! Encrypt fail, check data, key or cipher.');
        }
    }
    ...
    public function decrypt() {
        if ($this->validateParams()) {
            ...
            throw new Exception('Invalid params! Decrypt fail, check data, key or cipher!');
        }
    }
